...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2024 a las 01:59:02
...
INSERT INTO `tipo_daño` (`id_daño`, `nombre`, `precio`) VALUES
(1, 'Pantalla azul o de congelamiento', 100),
(2, 'Infección de Malware', 200),
(3, 'Perdida de datos', 300),
(4, 'Interferencia entre programas', 400),
(5, 'Problemas de conectividad', 500),
(6, 'Problemas de temperatura', 600),
(7, 'Problemas de alimentación', 700),
(8, 'Problemas de almacenamiento', 800);
...
(544536534, 'Ana Paul', 'tecnelectrics@gmail.com', '$2y$10$AI.HXNjtVW/NL0B0.w1F8ugRrJ.x403Kse1zlXg1A8zNZx7WkLrH.', 6535, '3202174961', 'mz casa 145445', 12345, 3),
(654789123, 'santiago', 'santiago@misena', '$2y$10$VSbHEFu/n3X7yN42zNlgm.DLtQre8Q5mKS/O/u0wAMNpRH7cVYYnq', 987654, '311804567', 'mz-casa-11', 12345, 2),
...
--
ALTER TABLE `licencia`
  MODIFY `codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=920;
...
--
ALTER TABLE `riesgos`
  MODIFY `id_riesgo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `roles`
--
ALTER TABLE `roles`
  MODIFY `id_tip_usu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tipo_daño`
  MODIFY `id_daño` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
