        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="nosotros.php" class="h5 text-white">Nosotros</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Nuestra Identidad Compromiso y Excelencia en el Servicio</h1>
                    </div>
                    <p class="mb-4">Somos un equipo dedicado de profesionales apasionados por la tecnología y
                        comprometidos con ofrecer soluciones integrales a nuestros clientes. Nos distingue nuestra
                        capacidad para comprender las complejidades del software y hardware, transformando cualquier
                        tipo de desafíos en oportunidades de crecimiento y mejora.</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Apasionados por lo que
                                hacemos, resolvemos tus problemas.</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Apoyándote en cada paso, tu
                                éxito es nuestro éxito.</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Afrontamos desafíos para
                                crecer y mejorar juntos como equipo.</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Soluciones adaptadas a ti,
                                entendiendo tus necesidades individuales únicas.</h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                            src="Assets/img/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Proporcionar soluciones integrales y eficientes para resolver
                                    los problemas informáticos de nuestros clientes, ya sea relacionados con software o
                                    hardware.
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">La integridad, responsabilidad, amabilidad y paciencia son los
                                    pilares sobre los cuales construimos todas nuestras relaciones,
                                    tanto internas como externas. Valorando la transparencia y la honestidad en cada
                                    interacción, comprometiendonos a buscar constantemente soluciones. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Nos visualizamos como líderes en el campo de la asistencia
                                    tecnológica,
                                    siendo reconocidos por nuestra excelencia en la resolución de problemas
                                    informáticos.
                                    Buscamos ser un referente en la industria, siendo innovadores en la implementación
                                    de tecnologías
