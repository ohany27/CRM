...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($affected_rows > 0) {
            ...
            echo "<script>alert('No se pudo generar la llamada'); window.location='../Visualizar/nuevo_llamada.php';</script>";
            exit();
        }
...
<ul class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justfied" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link px-4 active" href="../Visualizar/nuevo_llamada.php">
            <span class="d-block d-sm-none"><i class="mdi mdi-menu-open"></i></span>
    ...
    <div class="tab-content p-4">
        <div class="tab-pane active show" id="projects-tab" role="tabpanel">
            <div class="d-flex align-items-center">
                <div class="flex-1">
                    <h4 class="card-title mb-4">Genera Una Llamada</h4>
                </div>
            </div>
