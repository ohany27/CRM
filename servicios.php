        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="servicios.php" class="h5 text-white">Servicios</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Optimización de Tecnología para un Negocio Triunfante</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Soporte técnico por teléfono</h4>
                        <p class="m-0">Proporcionar asistencia inmediata a los usuarios que experimenten problemas con sus equipos informáticos a través de llamadas telefónicas, ofreciendo soluciones remotas siempre que sea posible.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Visitas de técnicos</h4>
                        <p class="m-0">Coordinar la visita de técnicos altamente capacitados y equipados para abordar problemas que no puedan resolverse por teléfono, asegurando una atención profesional y eficiente.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Mantenimiento preventivo programado</h4>
                        <p class="m-0">Permitir a los usuarios programar servicios de mantenimiento periódicos, como actualizaciones de software, limpieza de hardware y revisiones de seguridad.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Registro de tickets de servicio</h4>
                        <p class="m-0">Proporcionar a los usuarios un número de ticket único para problemas técnicos que requieran atención personalizada, facilitando el seguimiento y la gestión eficiente de cada solicitud de servicio.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Asesoramiento técnico</h4>
                        <p class="m-0">Ofrecer orientación y recomendaciones a los usuarios sobre el mantenimiento adecuado de sus equipos informáticos, así como sobre la optimización de su rendimiento y seguridad.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Actualizaciones a Tiempo real</h4>
                        <p class="m-0">Mantener a los usuarios informados sobre el progreso de sus solicitudes de servicio mediante actualizaciones en tiempo real sobre el estado de sus tickets y visitas programadas.</p>
